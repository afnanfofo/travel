    ...
    <div class="products">
      <div class="container">
        <div class="row">
            ...
            $sql="select * from travels where featured='Yes' and active='Yes' limit 3";
            ...
            ?>
                ...
                <div class="col-md-4">
                    <div class="product-item">
                        <a href="package-details.php"><img src="" alt="<?php echo $image;?>"></a>
                        <div class="down-content">
                            <a href="package-details.php"><h4><?php echo $title;?></h4></a>
